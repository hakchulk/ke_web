  ...
  return (
    <>
      <div className="bg-gray-200 w-full h-screen flex justify-center items-center">
        <div className=" w-[70%] sm:w-120 rounded-2xl border-gray-200 shadow-xl p-8">
          <div className="mb-6">
          ...
          <div className="mb-6">
            <button className="flex w-full bg-blue-200 p-2 rounded border-gray-300 text-sm justify-center items-center mb-4 hover:bg-blue-300 gap-2">
          ...
          <div className="mb-6">
            <form action="" className="mb-4">
              ...
              <div className="mb-6">
                <label htmlFor="pdw" className="block text-sm mb-2">
                  password
                </label>
                <input
                  type="text"
              ...
              <button className="flex justify-center items-center gap-3 w-full rounded-lg bg-info text-white py-2 hover:bg-blue-600 transition">
                <div className="w-5 h-5 bg-amber-400 animate-spin rounded-[2px]"></div>
                로그인
              </button>
            </form>
